    ...
    try:
        ...
        with open(output_txt, 'w', newline='', encoding='utf-8') as output_file:
            for row in rows:
                ...
                new_row = "vulnerability_Mac-Os-X-10.15.7(" + ",".join(modified_row) + ")."
...
input_tsv = "Mac-Os-X-10.15.7.tsv"
output_txt = "Mac-Os-X-10.15.7.txt"
newOutput_txt = "V2Mac-Os-X-10.15.7.txt"
